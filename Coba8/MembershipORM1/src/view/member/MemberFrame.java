...
public class MemberFrame extends JFrame {
    ...
    this.memberList = this.memberDao.findAll(); // Ambil ulang data dari database
    tableModel.setData(memberList); // Perbarui data di model tabel
    tableModel.fireTableDataChanged(); // Beritahu JTable bahwa data berubah
}
